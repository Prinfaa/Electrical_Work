package com.jawg.electricalshow.view;
...
//    private Runnable clockRunnable;
    ...
    private float hourAngle = 90, minAngle = 210, secAngle = 330;//时针  分针 秒针 的角度
    ...
    public ClockView(Context context, AttributeSet attrs) {
        ...
        Log.e("radius", "ClockView: ==heigth==>"+heigth/9 );
...
//		canvas.drawLine(getWidth() / 2, getHeight() / 2, getWidth() / 2, getHeight() / 2 - 260, Hpaint);//时针长度设置为200
        drawAL(getWidth() / 2, getHeight() / 2, getWidth() / 2, getHeight() / 2 - heigth/9, canvas, Hpaint);
        canvas.restore();//坐标轴 复位
        canvas.save();

        canvas.rotate(minAngle, getWidth() / 2, getHeight() / 2);
//		canvas.drawLine(getWidth() / 2, getHeight() / 2, getWidth() / 2, getHeight() / 2 - 260 , Mpaint);//分针长度设置为200
        drawAL(getWidth() / 2, getHeight() / 2, getWidth() / 2, getHeight() / 2 - heigth/9, canvas, Mpaint);
        canvas.restore();

        canvas.save();
        canvas.rotate(secAngle, getWidth() / 2, getHeight() / 2);
//		canvas.drawLine(getWidth() / 2, getHeight() / 2, getWidth() / 2, getHeight() / 2 - 260 , Spaint);//秒针长度设置为200
        drawAL(getWidth() / 2, getHeight() / 2, getWidth() / 2, getHeight() / 2 - heigth/9, canvas, Spaint);
        canvas.restore();
...
//		canvas.drawLine(getWidth() / 2, getHeight() / 2, getWidth() / 2, getHeight() / 2 - 260 , Spaint);//秒针长度设置为150
            drawAL(getWidth() / 2, getHeight() / 2, getWidth() / 2, getHeight() / 2 - heigth/10, canvas, milspaint);
            canvas.restore();
...
//		}
    ...
    private void drawClockCircle(Canvas canvas) {
        ...
        canvas.drawCircle(x, y, (float) (radius - radius/3), mPaint);
        canvas.drawCircle(x, y, radius - radius/3*2, mPaint);
    }
